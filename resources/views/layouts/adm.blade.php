...
<header class="main-header">
  ...
  <a href="index2.html" class="logo">
    ...
    <span class="logo-mini"><b>V</b>DC</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>Vex</b>Doc </span>
  </a>
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        ...
        <!-- Control Sidebar Toggle Button -->
         <li>
          <a href="/logout" ><i class="fa fa-fw fa-sign-out"></i></a>
        </li> 
      </ul>
    </div>
  </nav>
  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-left image">
        <img src="/dist/img/Danny-Baskara.jpg" class="img-circle" alt="User Image">
      </div>
...
<footer class="main-footer">
  ...
  <strong>Copyright &copy; 2019 <a href="#">vexanium</a>.</strong> All rights
  reserved.
</footer>
