            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  @if( Request::segment(4) == 'en')
                    <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{ $data->name }}">
                  @else
                   <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{ $data->name_id }}">
                  @endif
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select  class="form-control"  name="menu" id="menu">
                      ...
                      @foreach($menu as $l)
                        <option value="{{ $l->id }}" <?php if($l->id == $data->sub){ echo 'selected'; }?>>
                        @if(empty($l->name))    
                        {{ $l->name_id }}
                        @else
                          {{ $l->name }}
