...
! function(t) {
        ...
        (function(t) {
            ! function(e) {
                    ...
                    a = function() {
                        ...
                        return a.setMaxPendingRequests = function(t) {
                            ...
                            _get: function(e, n, o) {
                                ...
                                this.cancelled || e !== this.lastUrl || ((s = r[e]) ? s.done(u).fail(c) : t < i ? (t++, r[e] = this._send(e, n).done(u).fail(c).always(l)) : this.onDeckRequestArgs = [].slice.call(arguments, 0))
                            },
                            get: function(t, e, r) {
                                var i;
                        ...
                        return {
                            ...
                            prefetch: function(t) {
                                ...
                                o = {
                                    ...
                                    filter: null,
                                    ajax: {}
                                }, (i = t.prefetch || null) && (i = n.isString(i) ? {
                                    url: i
                                } : i, (i = n.mixin(o, i)).thumbprint = r + i.thumbprint, i.ajax.type = i.ajax.type || "GET", i.ajax.dataType = i.ajax.dataType || "json", !i.url && e.error("prefetch requires url to be set"));
                                return i
                            },
                            remote: function(t) {
                                var r, i;
                                i = {
                                    ...
                                    filter: null,
                                    ajax: {}
                                }, (r = t.remote || null) && (r = n.isString(r) ? {
                                    url: r
                                } : r, (r = n.mixin(i, r)).rateLimiter = /^throttle$/i.test(r.rateLimitBy) ? (o = r.rateLimitWait, function(t) {
                ...
                ! function(t) {
                    ...
                    function l(t) {
                        var r;
                        t && (t.local || t.prefetch || t.remote) || e.error("one of local, prefetch, or remote is required"), this.limit = t.limit || 5, this.sorter = (r = t.sorter, n.isFunction(r) ? function(t) {
                            return t.sort(r)
                        } : function(t) {
                            return t
                        }), this.dupDetector = t.dupDetector || h, this.local = c.local(t), this.prefetch = c.prefetch(t), this.remote = c.remote(t), this.cacheKey = this.prefetch ? this.prefetch.cacheKey || this.prefetch.url : null, this.index = new u({
                ...
                var l = {
                    ...
                    d = function() {
                        ...
                        return {
                            ...
                            trigger: function(t) {
                                ...
                                for (;
                                    (r = t.shift()) && (o = this._callbacks[r]);) a = i(o.sync, this, [r].concat(s)), u = i(o.async, this, [r].concat(s)), a() && n(u);
                                return this
                            }
                        };
                    ...
                    f = function(t) {
                        ...
                        return function(r) {
                            ...
                            (r = n.mixin({}, e, r)).node && r.pattern && (r.pattern = n.isArray(r.pattern) ? r.pattern : [r.pattern], i = function(t, e, r) {
                                ...
                                for (var r, i = 0; i < e.childNodes.length; i++) 3 === (r = e.childNodes[i]).nodeType ? i += n(r) ? 1 : 0 : t(r, n)
                            }(r.node, (function(e) {
                                var n, o, s;
                    ...
                    m = function() {
                        ...
                        function o(t) {
                            var r, i, o, s;
                            (t = t || {}).templates = t.templates || {}, t.source || e.error("missing source"), t.name && (r = t.name, !/^[_a-zA-Z0-9-]+$/.test(r)) && e.error("invalid dataset name: " + t.name), this.query = null, this.highlight = !!t.highlight, this.name = t.name || n.getUniqueId(), this.source = t.source, this.displayFn = (i = (i = t.display || t.displayKey) || "value", n.isFunction(i) ? i : function(t) {
                                return t[i]
                            }), this.templates = (o = t.templates, s = this.displayFn, {
                                // empty: o.empty && n.templatify(o.empty),
                                header: o.header && n.templatify(o.header),
                                // footer: o.footer && n.templatify(o.footer),
                                suggestion: o.suggestion || function(t) {
                                    return "<p>" + s(t) + "</p>"
                                }
                            }), this.$el = e(l.dataset.replace("%CLASS%", this.name))
                        }
                        return o.extractDatasetName = function(n) {
                            ...
                            _render: function(o, s) {
                                if (this.$el) {
                                    var a, u, c, p = this;
                                    this.$el.empty(), !(a = s && s.length) && this.templates.empty ? this.$el.html(p.templates.empty({
                                        query: o,
                                        isEmpty: !0
                                    })).prepend(p.templates.header ? d() : null).append(p.templates.footer ? g() : null) : a && this.$el.html((u = e(l.suggestions).css(h.suggestions), c = n.map(s, (function(n) {
                                        var o;
                                        return (o = e(l.suggestion).append(p.templates.suggestion(n)).data(t, p.name).data(r, p.displayFn(n)).data(i, n)).children().each((function() {
                                            e(this).css(h.suggestionChild)
                                        })), o
                                    })), u.append.apply(u, c), p.highlight && f({
                                        className: "tt-highlight",
                                        node: u[0],
                                        pattern: o
                                    }), u)).prepend(p.templates.header ? d() : null).append(p.templates.footer ? g() : null), this.trigger("rendered")
                                }
                    ...
                    v = function() {
                        ...
                        function r(r) {
                            ...
                            (r = r || {}).input || e.error("missing input"), this.isActivated = !1, this.autoselect = !!r.autoselect, this.minLength = n.isNumber(r.minLength) ? r.minLength : 1, this.$node = function(n, r) {
                                ...
                                t.preventDefault()
                            })), this.eventBus = r.eventBus || new p({
                                el: o
                            }), this.dropdown = new y({
                                menu: i,
                                datasets: r.datasets
                ...
                ! function() {
                    ...
                    t = e.fn.typeahead, r = "ttTypeahead", i = {
                        initialize: function(t, i) {
                            return i = n.isArray(i) ? i : [].slice.call(arguments, 1), t = t || {}, this.each(o);
                        ...
                        val: function(t) {
                            ...
                            function n() {
                                var n;
                                (n = e(this).data(r)) && n.setVal(t)
                            }

                            function i(t) {
                                var e, n;
                                return (e = t.data(r)) && (n = e.getVal()), n
                            }
                        },
                        destroy: function() {
                            return this.each((function() {
    ...
    "5HLv": function(t, e, n) {
            ...
            t.Template = function(t, e, n, r) {
                ...
                d: function(t, n, r, i) {
                    var o, s = t.split("."),
                        ...
                        c = null;
                    if ("." === t && l(n[n.length - 2])) a = n[n.length - 1];
                    else
                        for (var h = 1; h < s.length; h++) void 0 !== (o = e(s[h], a, u)) ? (c = a, a = o) : a = "";
                    return !(i && !a) && (i || "function" != typeof a || (n.push(c), a = this.mv(a, n, r), n.pop()), a)
                },
                f: function(t, n, r, i) {
                    for (var o = !1, s = !1, a = this.options.modelGet, u = n.length - 1; u >= 0; u--)
                        if (void 0 !== (o = e(t, n[u], a))) {
                            s = !0;
                            break
        ...
        function(t) {
            ...
            t.tags = {
                ...
                function b(n, r) {
                    if (v(), n && function() {
                            for (var n = !0, r = g; r < p.length; r++)
                                if (!(n = t.tags[p[r].tag] < t.tags._v || "_t" == p[r].tag && null === p[r].text.match(e))) return !1;
                            return n
                        }())
                        for (var i, o = g; o < p.length; o++) p[o].text && ((i = p[o + 1]) && ">" == i.tag && (i.indent = p[o].text.toString()), p.splice(o, 1));
                    else r || p.push({
                        tag: "\n"
                    });
                    d = !1, g = p.length
                ...
                function w(t, e) {
                    var n = "=" + y,
                        r = t.indexOf(n, e),
                        i = c(t.substring(t.indexOf("=", e) + 1, r)).split(" ");
            ...
            t.generate = function(e, n, r) {
                ...
                return function e(n, r, i, o) {
                    ...
                    for (s = i[i.length - 1]; n.length > 0;) {
                        ...
                        if (t.tags[c.tag] <= t.tags.$ || p(c, o)) i.push(c), c.nodes = e(n, c.tag, i, o);
                        else {
                            if ("/" == c.tag) {
            ...
            "undefined" != typeof window ? u = window : "undefined" != typeof self && (u = self), u.ALGOLIA_MIGRATION_LAYER = function t(e, n, r) {
                ...
                1: [function(t, e, n) {
                    ...
                    e.exports = function(t, e, n) {
                        ...
                        "function" == typeof e && (n = e, e = {}), e = e || {}, n = n || function() {}, s.type = e.type || "text/javascript", s.charset = e.charset || "utf8", s.async = !("async" in e && !e.async), s.src = t, e.attrs && function(t, e) {
                            for (var n in e) t.setAttribute(n, e[n])
                        }(s, e.attrs), e.text && (s.text = "" + e.text), ("onload" in s ? r : i)(s, n), s.onload || r(s, n), o.appendChild(s)
                    }
                }, {}],
                2: [function(t, e, n) {
                    "use strict";
                    e.exports = function(t) {
                        for (var e = new RegExp("cdn\\.jsdelivr\\.net/algoliasearch/latest/" + t.replace(".", "\\.") + "(?:\\.min)?\\.js$"), n = document.getElementsByTagName("script"), r = !1, i = 0, o = n.length; i < o; i++)
                            if (n[i].src && e.test(n[i].src)) {
                                r = !0;
                                break
                            } return r
                    }
                ...
                return function t(e, n, r) {
                    ...
                    1: [function(t, e, n) {
                        ...
                        e.exports = r, r.EventEmitter = r, r.prototype._events = void 0, r.prototype._maxListeners = void 0, r.defaultMaxListeners = 10, r.prototype.setMaxListeners = function(t) {
                            ...
                            return this._events || (this._events = {}), this._events.newListener && this.emit("newListener", t, i(e.listener) ? e.listener : e), this._events[t] ? o(this._events[t]) ? this._events[t].push(e) : this._events[t] = [this._events[t], e] : this._events[t] = e, o(this._events[t]) && !this._events[t].warned && (n = s(this._maxListeners) ? r.defaultMaxListeners : this._maxListeners) && n > 0 && this._events[t].length > n && (this._events[t].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[t].length), "function" == typeof console.trace && console.trace()), this
                    ...
                    3: [function(t, e, n) {
                        ...
                        e.exports = function(t, e, n, o) {
                            ...
                            u > 0 && c > u && (c = u);
                            for (var l = 0; l < c; ++l) {
                                var h, p, d, f, g = t[l].replace(a, "%20"),
                                    m = g.indexOf(n);
                        ...
                        (n = e.exports = function(t) {
                            ...
                            function o() {
                                ...
                                a[0] = a[0].replace(/%([a-z%])/g, (function(e, r) {
                                    ...
                                    return e
                                })), "function" == typeof n.formatArgs && (a = n.formatArgs.apply(t, a)), (o.log || n.log || console.log.bind(console)).apply(t, a)
                            }
                    ...
                    9: [function(t, e, i) {
                        (function(n, i) {
                            (function() {
                                ...
                                function A() {
                                    for (var t = 0; t < c; t += 2)(0, S[t])(S[t + 1]), S[t] = void 0, S[t + 1] = void 0;
                                    c = 0
                                }
                                ...
                                g ? (k = n.nextTick, j = n.versions.node.match(/^(?:(\d+)\.)?(?:(\d+)\.)?(\*|\d+)$/), Array.isArray(j) && "0" === j[1] && "10" === j[2] && (k = r), v = function() {
                                    k(A)
                                }) : f ? (w = 0, _ = new f(A), x = document.createTextNode(""), _.observe(x, {
                                    characterData: !0
                                }), v = function() {
                                    x.data = w = ++w % 2
                    ...
                    22: [function(t, e, n) {
                        ...
                        e.exports = function t(e, n, h, p, d) {
                            ...
                            return r(g || n, (function(r, o) {
                                if (g && (r = n[o = r]), u(r)) p || (p = []), d || (d = []), i(e, n, o, t, h, p, d);
                                else {
                                    var s = e[o],
                                        a = h ? h(s, r, o, e, n) : void 0,
                                        c = void 0 === a;
                    ...
                    23: [function(t, e, n) {
                        ...
                        e.exports = function(t, e, n, l, h, p, d) {
                            for (var f = p.length, g = e[n]; f--;)
                                if (p[f] == g) return void(t[n] = d[f]);
                            var m = t[n],
                                y = h ? h(m, g, n, t, e) : void 0,
                                v = void 0 === y;
                    ...
                    60: [function(t, e, n) {
                        (function(n) {
                            ...
                            function i(e, n, i) {
                                ...
                                var p = (i = i || {}).protocol || "https:",
                                    d = void 0 === i.timeout ? 2e3 : i.timeout;
                            ...
                            i.prototype = {
                                ...
                                _jsonRequest: function(e) {
                                    var i, o = t(6)("algoliasearch:" + e.url),
                                        s = e.cache,
                                        a = this,
                                        u = 0,
                                        l = !1;
                                    void 0 !== e.body && (i = p(e.body)), o("request start");
                                    var h = a.useFallback && e.fallback,
                                        d = h ? e.fallback : e,
                                        f = function t(c, h) {
                                            var d;
                                            ...
                                            var f = a.hosts[e.hostType][a.hostIndex[e.hostType]] + h.url,
                                                g = {
                                                    body: i,
                                                    jsonBody: e.body,
                                                    method: h.method,
                                ...
                                deleteByQuery: function(t, e, n) {
                                    ...
                                    function a(t) {
                                        ...
                                        return r.deleteObjects(e).then(u).then(l)
                                    }
                                ...
                                browse: function(e, n, r) {
                                    ...
                                    return this.as._jsonRequest({
                                        method: "GET",
                                        url: "/1/indexes/" + encodeURIComponent(a.indexName) + "/browse?" + u,
                                        hostType: "read",
                                        callback: r
                                    })
                                },
                        ...
                        r(h, o), h.prototype._request = function(t, e) {
                            return new i((function(n, r) {
                                if (l.cors || l.hasXDomainRequest) {
                                    ...
                                    c instanceof XMLHttpRequest ? c.open(e.method, t, !0) : c.open(e.method, t), l.cors && (u && ("POST" === e.method ? c.setRequestHeader("content-type", "application/x-www-form-urlencoded") : c.setRequestHeader("content-type", "application/json")), c.setRequestHeader("accept", "application/json")), c.onprogress = function() {}, c.onload = function() {
                                        if (!o) {
                                            var t;
                                        ...
                                        o || (l.timeout || clearTimeout(i), r(new s.Network({
                                            more: t
                                        })))
                    ...
                    64: [function(t, e, n) {
                        "use strict";
                        e.exports = function(t, e) {
                            return /\?/.test(t) ? t += "&" : t += "?", t + r.encode(e)
                        };
                        var r = t(5)
                    }, {
                        5: 5
                        ...
                        e.exports = function(t, e, n) {
                            if ("GET" === e.method) {
                                ...
                                u.onreadystatechange = function() {
                                    ...
                                    e.debug("JSONP: Script error"), l || s || (d(), n(new r.JSONPScriptError))
                                }, u.async = !0, u.defer = !0, u.src = t, a.appendChild(u)
                            } else n(new Error("Method " + e.method + " " + t + " is not supported by JSONP."));
    ...
    bUC5: function(t, e, n) {
        $(document).ready((function() {
            ...
            })), $("#docsScreen").length && n("RsYP"), "" != '', $(".header_content .search_box").click((function(t) {
